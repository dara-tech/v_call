  ...
  return (
    <div className="relative flex h-full min-h-0 w-full flex-col items-center justify-center px-safe py-6">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute left-1/2 top-1/2 size-56 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/10 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 flex w-full max-w-sm flex-col items-center gap-6 sm:gap-8">
        <div className="relative flex size-16 items-center justify-center sm:size-20">
          ...
          <Users className="relative size-8 text-cyan-300/70 sm:size-9" />
        </div>

        <button
          type="button"
          onClick={onCopyInvite}
          className="flex w-full items-center gap-3 rounded-2xl border border-white/10 bg-zinc-950/70 px-3 py-3 shadow-2xl backdrop-blur-xl transition-colors hover:border-white/20 hover:bg-zinc-900/80 sm:px-4"
        >
